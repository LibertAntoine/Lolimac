...
class EventManager extends DBAccess {
	public function add(Event $event) {
      ...
      VALUES (:title, :description, :date_start, :date_end, NOW());");
  ...
  public function update(Event $event) {
    $q = $this->db->prepare('UPDATE events SET title = :title, description = :description, date_start = :date_start, date_end = :date_end WHERE id = :id');
